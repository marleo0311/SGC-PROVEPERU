...
class OpenApiIntegrationTests {
    ...
    void especificacionOpenApiEsPublicaYContieneLosEndpoints() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
            ...
            .andExpect(jsonPath(
                "$.paths['/api/v1/cuentas-cobrar/saldos-iniciales'].post.security"
            ).exists())
            .andExpect(jsonPath(
            ...
            .andExpect(jsonPath("$.paths['/api/v1/cajas'].get.security").exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/cajas/{id}/aperturas'].post.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/cajas/{id}/sesion-activa'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/sesiones-caja/{id}/movimientos'].post.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/sesiones-caja/{id}/movimientos'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/sesiones-caja/{id}/cierre'].post.security"
            ).exists())
            .andExpect(jsonPath(
            ...
            .andExpect(jsonPath(
                "$.paths['/api/v1/devoluciones/{id}/cambio'].post.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/devoluciones/{id}/descuento'].post.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/comprobantes/{id}'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/ventas/{idVenta}/comprobante'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/comprobantes/{id}/representacion'].get.security"
            ).exists())
            .andExpect(jsonPath(
            ...
            .andExpect(jsonPath(
                "$.paths['/api/v1/reportes/dashboard'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/reportes/ventas'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/reportes/inventario'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/reportes/finanzas'].get.security"
            ).exists())
            .andExpect(jsonPath(
                "$.paths['/api/v1/reportes/caja'].get.security"
            ).exists());
    }

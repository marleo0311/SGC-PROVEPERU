    ...
    <div className="modal-backdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && !saving && onClose()}>
      <section className="form-modal presentation-form-modal" role="dialog" aria-modal="true">
        ...
        <div className="form-modal__body presentation-form-body">
          ...
          <div className="catalog-form-intro"><i className="bi bi-info-circle" /><span><strong>El stock siempre se controla en {product.unidadBase.nombre}</strong><small>Cada bulto conservará su contenido real y podrá abrirse antes de vender por {product.unidadBase.nombre}.</small></span></div>

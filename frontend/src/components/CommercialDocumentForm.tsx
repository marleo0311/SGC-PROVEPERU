...
export function CommercialDocumentForm({ kind, quote, initialOrder, onClose, onSaved }: Props) {
  ...
  async function addProduct(product: Producto) {
    ...
    setLines((current) => [...current, { idProducto: product.id, codigo: product.codigoInterno, producto: product.nombre, idUnidad: product.unidadBase.id, unidad: product.unidadBase.codigo, cantidad: '1', tipoPrecio: saleType, precios: map, descuentoUnitario: '0' }])

...
export async function downloadReceiptPdf(idComprobante: number): Promise<Blob> { const { data } = await api.get<Blob>(`/v1/impresiones/comprobante/${idComprobante}/pdf`, { responseType: 'blob' }); return data }
